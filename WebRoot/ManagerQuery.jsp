      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="ManagerQuery.action">
                <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    
                    <td width="72%">查询：
					<label id="workno">部门编号</label>
                  ...
                  <tr align="center"  class="t1">
                    ...
                    <td width="14%" bgcolor="#D5E4F4"><strong>职位</strong></td>
					 <td width="14%" bgcolor="#D5E4F4"><strong>状态</strong></td>
					  <td width="16%" bgcolor="#D5E4F4"><strong>银行卡</strong></td>
                  </tr>
                  <s:iterator id="cc" value="workers">
                    <tr align="center">
